...
@section('content')
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    --}}
      <form method="POST" action="{{ route('memos.destroy', $memo) }}" onsubmit="return confirm('削除する？')">
        @csrf
        @method('DELETE')
  ...
  <pre class="rounded border bg-white p-3" style="white-space: pre-wrap;">{{ $memo->content }}</pre>
